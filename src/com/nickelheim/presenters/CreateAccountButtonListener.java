...
public class CreateAccountButtonListener {
    ...
    private User user;
    /**
     * accountBeingViewed instance variable.
     */
    public static Account accountBeingViewed = null;
    /**
     * constructor.
     * @param viewInput is the activity
     * @param contextInput is the context
     */
    public CreateAccountButtonListener(CreateAccountActivity viewInput,
    ...
    /**
     * method to attempt creation of account. 
     */
    ...
    /**
     * class that represents account creation task.
     * @author Nickelheim
     *
     */
    private class AccountCreationTask extends AsyncTask<String, Void, Account> {
        ...
        /**
         * method called for pre execution.
         */
        protected void onPreExecute() {
            balance = view.getBalance();
        }
        /**
         * method for background processes.
         * 
