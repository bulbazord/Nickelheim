...
public class NickelOpenHelper extends OrmLiteSqliteOpenHelper {
    ...
    /**
     * DATABASE_NAME instance variable.
     */
    ...
    /**
     * transactionDao instance variable.
     */
     ...
     */
    public NickelOpenHelper(Context contextInput) {
        super(contextInput, DATABASE_NAME, null, DATABASE_VERSION);
    }
     ...
     *
     * @param db the Database in which the table is created
     * @param connectionSource is the connection source
     */
    @Override
     ...
     * @param cs is the connection source
     * @param oldVersion is the old version integer
     * @param newVersion is the new version integer
     */
    @Override
     ...
     * @throws SQLException is an exception
     */
    ...
    /**
     * portfolioDao instance variable.
     */
